...
class load_data():
    ...
    def get_train_triples(self,triples_path,entid2clustid,rel2id,id2rel, self_triples):
        ...
        return np.array(trip_list), label_graph, neighbors_incoming, neighbors_outgoing
    ...
    def fetch_data(self):
        ...
        self.train_trips,self.label_graph, self.neighbors_incoming, self.neighbors_outgoing = self.get_train_triples(self.data_files["train_trip_path"],
